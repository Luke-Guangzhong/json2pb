...
void test_cvt_json_bool_to_uint32(void);
void test_cvt_json_array_to_uint32(void);
void test_cvt_json_object_to_uint32(void);
...
void test_cvt_json_str_overflow_ulong(void);
...
CU_TestInfo test_uint32_conversion[] = {
    ...
    {"Reject conversion of JSON bool to Protobuf uint32 field",   test_cvt_json_bool_to_uint32                 },
    {"Reject conversion of JSON array to Protobuf uint32 field",  test_cvt_json_array_to_uint32                },
    {"Reject conversion of JSON object to Protobuf uint32 field", test_cvt_json_object_to_uint32               },
    CU_TEST_INFO_NULL,
};
...
CU_TestInfo test_uint32_overflow[] = {
    ...
    {"Reject conversion of JSON string to C unsigned long on overflow",   test_cvt_json_str_overflow_ulong     },
    CU_TEST_INFO_NULL,
};
...
test_cvt_json_array_to_repeated_uint32(void) {
    ...
    const uint32_t expect_array[] = {1234567890, 1234567890, 0x4a0, 0110, 123};
#endif
    ...
    CU_ASSERT_EQUAL(e, J2P_EXPT_SUCCESS);
    CU_ASSERT_EQUAL(msg->n_f_repeated_uint32, expect_length);
    CU_ASSERT_EQUAL(memcmp(msg->f_repeated_uint32, expect_array, expect_length * sizeof(uint32_t)), 0);
}
