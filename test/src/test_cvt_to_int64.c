...
void test_cvt_json_bool_to_int64(void);
void test_cvt_json_array_to_int64(void);
void test_cvt_json_object_to_int64(void);
...
void test_cvt_json_inf_to_int64(void);
void test_cvt_json_nan_to_int64(void);
...
CU_TestInfo test_int64_conversion[] = {
    ...
    {"Reject conversion of JSON bool to Protobuf int64",        test_cvt_json_bool_to_int64                 },
    {"Reject conversion of JSON number to Protobuf int64",      test_cvt_json_array_to_int64                },
    {"Reject conversion of JSON object to Protobuf int64",      test_cvt_json_object_to_int64               },
    CU_TEST_INFO_NULL,
};
...
CU_TestInfo test_int64_overflow[] = {
    ...
    {"Reject conversion of invalid cjson(inf) to protobuf int64 on overflow", test_cvt_json_inf_to_int64          },
    {"Reject conversion of invalid cjson(nan) to protobuf int64 on overflow", test_cvt_json_nan_to_int64          },
...
void
test_cvt_json_bool_to_int64(void) {
    cJSON_AddTrueToObject(root, int64_field_name);
...
void
test_cvt_json_array_to_int64(void) {
    cJSON_AddArrayToObject(root, int64_field_name);
...
void
test_cvt_json_object_to_int64(void) {
    cJSON_AddObjectToObject(root, int64_field_name);
...
void
test_cvt_json_inf_to_int64(void) {
    cJSON_AddNumberToObject(root, int64_field_name, INFINITY);
...
void
test_cvt_json_nan_to_int64(void) {
    cJSON_AddNumberToObject(root, int64_field_name, NAN);
...
test_cvt_json_array_to_repeated_int64(void) {
    ...
    const int64_t expect_array[] = {1234567890, 1234567890, 0x4a0, 0b110, 0110, 123};
#else
    const char*   value          = "[1234567890, \"1234567890\",\"0x4a0\",\"0110\",123.45]";
    const int64_t expect_array[] = {1234567890, 1234567890, 0x4a0, 0110, 123};
#endif
    const size_t expect_length = sizeof(expect_array) / sizeof(int64_t);
    ...
    CU_ASSERT_EQUAL(e, J2P_EXPT_SUCCESS);
    CU_ASSERT_EQUAL(msg->n_f_repeated_int64, expect_length);
    CU_ASSERT_EQUAL(memcmp(msg->f_repeated_int64, expect_array, expect_length * sizeof(int64_t)), 0);
}
...
test_cvt_json_array_to_repeated_int64_partly_failed(void) {
    ...
    const int64_t expect_array[] = {1234567890, 0x4a0, 0110};
    const size_t  expect_length  = sizeof(expect_array) / sizeof(int64_t);
...
test_cvt_json_array_to_repeated_sint64(void) {
    ...
    size_t      expect_length  = sizeof(expect_array) / sizeof(int64_t);
