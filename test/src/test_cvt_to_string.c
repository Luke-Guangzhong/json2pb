...
CU_SuiteInfo suites[] = {
    {"Convert JSON to Protobuf enum field", init_sutie_name, cleanup_sutie_name, setup_successful_conversion, teardown_successful_conversion, test_string_conversion},
#if 0
