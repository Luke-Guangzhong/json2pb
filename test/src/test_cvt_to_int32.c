...
void test_cvt_json_bool_to_int32(void);
void test_cvt_json_array_to_int32(void);
void test_cvt_json_object_to_int32(void);
...
CU_TestInfo test_int32_conversion[] = {
    ...
    {"Reject conversion of JSON bool to Protobuf int32 field",   test_cvt_json_bool_to_int32                 },
    {"Reject conversion of JSON array to Protobuf int32 field",  test_cvt_json_array_to_int32                },
    {"Reject conversion of JSON object to Protobuf int32 field", test_cvt_json_object_to_int32               },
    CU_TEST_INFO_NULL,
};
...
void
test_cvt_json_bool_to_int32(void) {
...
void
test_cvt_json_array_to_int32(void) {
...
void
test_cvt_json_object_to_int32(void) {
...
test_cvt_json_array_to_repeated_int32_all_failed(void) {
    const char* value = "[\"invalid number string\",\"0x80000000\",null,{},\"test\"]";
