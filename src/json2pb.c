...
static j2p_expt_t cvt_field(const cJSON* const              root,
...
cvt_json_2_pb_field_v2(const cJSON* root, const cJSON* item, ProtobufCMessage* const msg, const char* const field_name, const j2p_add_cvt add_cvt)
{
    ...
    case PROTOBUF_C_TYPE_SFIXED32:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(int32_t), (single_field_cvt_func_v2)cvt_single_int32_t_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_INT64:
    case PROTOBUF_C_TYPE_SINT64:
    case PROTOBUF_C_TYPE_SFIXED64:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(int64_t), (single_field_cvt_func_v2)cvt_single_int64_t_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_UINT32:
    case PROTOBUF_C_TYPE_FIXED32:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(uint32_t), (single_field_cvt_func_v2)cvt_single_uint32_t_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_UINT64:
    case PROTOBUF_C_TYPE_FIXED64:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(uint64_t), (single_field_cvt_func_v2)cvt_single_uint64_t_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_FLOAT:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(float), (single_field_cvt_func_v2)cvt_single_float_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_DOUBLE:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(double), (single_field_cvt_func_v2)cvt_single_double_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_BOOL:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(bool), (single_field_cvt_func_v2)cvt_single_bool_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_ENUM:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(int), (single_field_cvt_func_v2)cvt_single_enum_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_STRING:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(char*), (single_field_cvt_func_v2)cvt_single_string_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_MESSAGE:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(ProtobufCMessage*), (single_field_cvt_func_v2)cvt_single_message_v2, add_cvt);
        break;
    case PROTOBUF_C_TYPE_BYTES:
        rtn = cvt_field(root, msg, item, field_desc, sizeof(ProtobufCBinaryData), (single_field_cvt_func_v2)cvt_single_bytes_v2, add_cvt);
        break;
    default:
...
static j2p_expt_t
cvt_field(const cJSON* const              root,
          ProtobufCMessage*               msg,
          const cJSON*                    item,
          const ProtobufCFieldDescriptor* field_desc,
          const size_t                    elem_size,
          ...
          j2p_add_cvt                     add_cvt)
{
    ...
    if (is_repeated) {
        ...
        return single_cvt(root, item, field_ptr, field_desc, add_cvt);
    }
}
