...
static const char* json_str = "{\"rx_bytes\":\"18446744073709551615\"}";
...
main()
{
    ...
    j2p_expt* e = cvt_cjson_2_proto_c_field(root, (ProtobufCMessage*)device, cJSON_GetObjectItem(root, "rx_bytes"), "rx_bytes");
    if (e != NULL) {
