...
typedef struct json2pb_additional_convertor {
...
typedef j2p_expt_t (
    *single_field_cvt_func_v2)(const cJSON* const root, const cJSON* const item, void* const field, const ProtobufCFieldDescriptor* const field_desc, const j2p_add_cvt add_cvt);
